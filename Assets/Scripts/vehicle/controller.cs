...
public class controller : MonoBehaviour{
    ...
    void FixedUpdate(){
        ...
        /*if(steeringWheel != null){
            ...
            float angle = Mathf.Rad2Deg * Mathf.Atan(horizontal)*1.33f;
            steeringWheel.transform.localRotation =Quaternion.Euler(0f,-angle , 0f);
        }*/
    }
    ...
    private void steerVehicle(){
        ...
        if (horizontal > 0 ) {
            ...
            wheels[0].steerAngle = Mathf.Rad2Deg * Mathf.Atan(1f / (finalTurnAngle - (1.5f / 2))) * horizontal;
            wheels[1].steerAngle = Mathf.Rad2Deg * Mathf.Atan(1f / (finalTurnAngle + (1.5f / 2))) * horizontal;
